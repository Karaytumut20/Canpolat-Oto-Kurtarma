...
export const metadata:Metadata={title:"İstanbul Yol ve Güzergâh Çekici Noktaları",description:"Şile Yolu, TEM, Kuzey Marmara Otoyolu ve Ümraniye bağlantılarında 7/24 çekici."};
