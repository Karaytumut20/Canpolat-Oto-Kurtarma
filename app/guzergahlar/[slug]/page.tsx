...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{const{slug}=await params;const e=findSeoEntry(routePages,slug);if(!e)return{};return{title:`${e.name} | 7/24 Yol Yardım`,description:`${e.short} Hızlı konum desteği: 0541 823 88 15.`,alternates:{canonical:`/guzergahlar/${slug}`}};}
