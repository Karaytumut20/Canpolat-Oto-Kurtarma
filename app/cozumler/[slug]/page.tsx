...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{const{slug}=await params;const e=findSeoEntry(problemPages,slug);if(!e)return{};return{title:`${e.name}, Ne Yapmalıyım? | 7/24 Çekici`,description:`${e.short} 7/24 yol yardım ve çekici: 0541 823 88 15.`,alternates:{canonical:`/cozumler/${slug}`}};}
