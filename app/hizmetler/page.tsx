...
export const metadata:Metadata={title:"Oto Kurtarma Hizmetleri | 7/24 Çekici",description:"İstanbul'da oto çekici, ahtapot vinç, yol yardım, akü takviyesi ve araç taşıma hizmetleri."};
